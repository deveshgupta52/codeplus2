  ...
  return (
    <div className="flex justify-center py-12">
      <div className="w-full max-w-md p-8 space-y-6 bg-card border border-border rounded-lg shadow-sm">
        ...
        {error && (
          <p className="text-destructive-foreground bg-destructive/80 rounded-md p-3 text-center text-sm">
            {error}
          </p>
        )}
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full py-2.5 px-4 bg-primary text-primary-foreground rounded-md font-semibold hover:bg-primary/90 transition-colors"
          >
            Login
          </button>
        </form>
