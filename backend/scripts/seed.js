...
<ul>
  ...
  <li><code>s</code> consists only of printable ASCII characters.</li>
        ...
        driverCode: {
            ...
            cpp: `#include <iostream>\n#include <string>\n#include <algorithm>\n#include <cctype>\n#include <stdexcept>\n\nusing namespace std;\n\nclass Solution {\npublic:\n    bool isPalindrome(string s) {\n        // USER_CODE_HERE\n    }\n};\n\nint main() {\n    string line;\n    string s_str;\n    try {\n      getline(cin, line);\n      // Assuming input is always a quoted string like "abc" or "a\\\"b"
      if (line.length() >= 2 && line.front() == '\"' && line.back() == '\"') {\n          s_str = line.substr(1, line.length() - 2);\n          // Handle escaped quotes within the string itself, e.g., "ab\\"cd"
          size_t pos = s_str.find("\\\"");
          while (pos != std::string::npos) { s_str.replace(pos, 2, "\""); pos = s_str.find("\\\"", pos + 1); }\n      } else {\n          // Fallback if not a quoted string, though test cases should provide quoted strings.
          s_str = line;
...
<br>
<strong>Explanation:</strong> Buy on day 2 (price = 1) and sell on day 5 (price = 6), profit = 6-1 = 5. Note that buying on day 2 and selling on day 1 is not allowed because you must buy before you sell.
<br><br>
<strong>Example 2:</strong>
<br>
...
<ul>
    ...
    <li><code>0 &lt;= prices[i] &lt;= 10^4</code></li>
        ...
        driverCode: {
            python: `import sys\nimport json\nfrom typing import List\n\nclass Solution:\n    def maxProfit(self, prices: List[int]) -> int:\n        # USER_CODE_HERE\n        pass\n\nif __name__ == '__main__':\n    line = sys.stdin.readline()\n    prices = json.loads(line.strip())\n    sol = Solution()\n    result = sol.maxProfit(prices)\n    print(result)\n`,
            javascript: `var maxProfit = function(prices) {\n    // USER_CODE_HERE\n};\n\nprocess.stdin.resume();\nprocess.stdin.setEncoding('utf-8');\nlet inputString = '';\nprocess.stdin.on('data', inputStdin => { inputString += inputStdin; });\nprocess.stdin.on('end', _ => {\n    const prices = JSON.parse(inputString.trim());\n    main(prices);\n});\n\nfunction main(prices) {\n    let result;\n    try {\n      if (typeof maxProfit !== 'function') throw new Error('maxProfit function not defined');\n      result = maxProfit(prices);\n    } catch(e) {\n        result = 0;\n        console.error("Runtime Error:", e.message);\n    }\n    console.log(result);\n}\n`,
            cpp: `#include <iostream>\n#include <vector>\n#include <string>\n#include <sstream>\n#include <algorithm>\n#include <stdexcept>\n\nusing namespace std;\n\nvector<int> parseVector(const string& str) {\n    vector<int> result;\n    if (str.length() <= 2) return result;\n    stringstream ss(str.substr(1, str.length() - 2));\n    string num_str;\n    while (getline(ss, num_str, ',')) {\n        num_str.erase(0, num_str.find_first_not_of(" \t"));\n        num_str.erase(num_str.find_last_not_of(" \t") + 1);\n        if (!num_str.empty()) try { result.push_back(stoi(num_str)); } catch(...) {}\n    }\n    return result;\n}\n\nclass Solution {\npublic:\n    int maxProfit(vector<int>& prices) {\n        // USER_CODE_HERE\n        return 0;\n    }\n};\n\nint main() {\n    string line;\n    vector<int> prices;\n    try {\n      getline(cin, line);\n      prices = parseVector(line);\n      Solution sol;\n      int result = sol.maxProfit(prices);\n      cout << result << endl;\n    } catch(const exception& e) {\n        cerr << "Exception caught in main: " << e.what() << endl;\n        cout << 0 << endl;\n    }\n    return 0;\n}`,
            java: `import java.util.*;\nimport java.io.*;\n\npublic class Main {\n    // USER_CODE_HERE\n    public static int maxProfit(int[] prices) {\n        // USER_CODE_HERE\n        return 0;\n    }\n\n    public static void main(String[] args) {\n      int[] prices = {};\n      try {\n        BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));\n        String line = reader.readLine();\n        reader.close();\n        String pricesStr = line.trim();\n        String content = pricesStr.substring(1, pricesStr.length() - 1);\n        if (!content.isEmpty()) {\n            String[] pricesArrStr = content.split(",");\n            prices = new int[pricesArrStr.length];\n            for (int i = 0; i < pricesArrStr.length; i++) { prices[i] = Integer.parseInt(pricesArrStr[i].trim()); }\n        }\n        Solution sol = new Solution();\n        int result = sol.maxProfit(prices);\n        System.out.println(result);\n      } catch (Exception e) {\n          System.err.println("Exception caught in main: " + e.getMessage());\n          System.out.println(0);\n      }\n    }\n}`
        },
        visibleTestCases: [
